...
python3 test.py --weights logs/LSTM_Data5_Batch-$b/weights_best.tar --dataset ./Data5 --model lstm --hidden_dim 16 --num_layers 2
#
...
python3 test.py --weights logs/RNN_Data5_Batch-$b/weights_best.tar --dataset ./Data5 --model rnn --hidden_dim 16 --num_layers 2
#
#
